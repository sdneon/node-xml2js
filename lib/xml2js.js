...
(function() {
  ...
  exports.Builder = (function() {
    ...
    Builder.prototype.buildObject = function(rootObj) {
      var attrkey, charkey, commentkey, ignoreComments, ignoreProcInst, procinstkey, render, rootElement, rootName;
      attrkey = this.options.attrkey;
      charkey = this.options.charkey;
      commentkey = this.options.commentkey;
      ignoreComments = this.options.ignoreComments;
      procinstkey = this.options.procinstkey;
      ignoreProcInst = this.options.ignoreProcInst;
          ...
          if (typeof obj !== 'object') {
            ...
            for (key in obj) {
              ...
              if (key === attrkey) {
                ...
                if (!ignoreComments && typeof child === "object") {
                  for (attr in child) {
                    if (!hasProp.call(child, attr)) continue;
                    value = child[attr];
                    element = element.comment(value);
                  }
                }
              } else if (key === procinstkey) {
                if (!ignoreProcInst && typeof child === "object") {
                  for (attr in child) {
                    if (!hasProp.call(child, attr)) continue;
                    value = child[attr];
  ...
  exports.Parser = (function(superClass) {
    ...
    Parser.prototype.reset = function() {
      var attrkey, charkey, commentkey, ontext, procinstkey, stack;
      ...
      this.saxParser.oncomment = (function(_this) {
        return function(node) {
          var s;
          if (_this.options.ignoreComments || stack.length <= 0) {
            return;
          }
          s = stack[stack.length - 1];
          return _this.assignOrPush(s, commentkey, node);
        };
      })(this);
      this.saxParser.onprocessinginstruction = (function(_this) {
        return function(node) {
          var s;
          if (_this.options.ignoreProcInst || stack.length <= 0) {
            return;
          }
          s = stack[stack.length - 1];
          return _this.assignOrPush(s, procinstkey, node);
        };
      })(this);
